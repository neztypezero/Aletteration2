...
@property(nonatomic, assign, getter=getListenerPos, setter=setListenerPos:) GLKVector3 listenerPos;
@property(nonatomic, assign, getter=getListenerGain, setter=setListenerGain:) float listenerGain;
@property(nonatomic, assign, getter=getListenerVelocity, setter=setListenerVelocity:) GLKVector3 listenerVelocity;
@property(nonatomic, assign, getter=getListenerOrientation, setter=setListenerOrientation:) GLKVector3 listenerOrientation;
